...
import { addressModalIsVisible } from '../store/wallet/actions'
            ...
            <div className={style.container}>
                <div className={style.titleContainer}>
                    ...
                    <AiOutlineClose
                        ...
                        onClick={() => dispatch(addressModalIsVisible(false))}
                    />
                </div>
                <div className={style.addressInfoContainer}>
                    <div className={style.addressContainer}>
                        ...
                        <button className="bg-slate-200 rounded-md text-sm px-2 py-1 hover:bg-slate-300">
                            Change
                        </button>
                    </div>
